...
/**
* Tetrahedron test.
* @author Chase Hopkins - COMP1210 - Project_07B
* @version 3/16/21
*/
...
public class TetrahedronTest {
   ...
   * null label test.
   */
   @Test public void nullLabelTest() {
      Tetrahedron test = new Tetrahedron("test", 1);
      test.setLabel(null);
      Assert.assertEquals(false, test.setLabel(null));
   }
   ...
   */
   ...
   /**
   * tests if edge is negative.
   */
   @Test public void negEdgeTest() {
      Tetrahedron test = new Tetrahedron("test", 1.0);
      test.setEdge(-1.0);
      Assert.assertEquals(false, test.setEdge(-1.0));
   }
   ...
   */
   ...
   @Test public void hashCodeTest() {
    ...
    /** method tests compareTo method. **/
   @Test public void compareToTest1() {
      Tetrahedron test = new Tetrahedron("test", 1);
      Tetrahedron test2 = new Tetrahedron("test2", 2);
      Assert.assertTrue(test.compareTo(test2) < 0);
   }
      
    /** method tests compareTo method. **/
   @Test public void compareToTest2() {
      Tetrahedron test = new Tetrahedron("test", 2);
      Tetrahedron test2 = new Tetrahedron("test2", 1);
      Assert.assertTrue(test.compareTo(test2) > 0);
   }
